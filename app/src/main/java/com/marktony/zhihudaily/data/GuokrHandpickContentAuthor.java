 ...
 */
public class GuokrHandpickContentAuthor {
    ...
    private GuokrHandpickContentAvatar avatar;
    ...
    public GuokrHandpickContentAvatar getAvatar() {
        return avatar;
    }

    public void setAvatar(GuokrHandpickContentAvatar avatar) {
        this.avatar = avatar;
    }
